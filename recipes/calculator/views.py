...
def recipe_view(request, recipe_name):
    servings = int(request.GET.get('servings', 1))  # Получаем количество порций, если указано, иначе 1
    recipe_data = DATA.get(recipe_name, {})  # Получаем данные рецепта, если они существуют
